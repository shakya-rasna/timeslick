defmodule DttRechargerWeb.CoreComponents do
  @moduledoc """
  ...
  import DttRechargerWeb.Gettext
  ...
  def table(assigns) do
    ...
    <div class="overflow-y-auto px-4 sm:overflow-visible sm:px-0">
      <table id={@id} class="w-[40rem] mt-11 sm:w-full js_datatable" style="width:100%">
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DttRechargerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DttRechargerWeb.Gettext, "errors", msg, opts)
    end
  end
