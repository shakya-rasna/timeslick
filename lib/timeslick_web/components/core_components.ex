defmodule TimeslickWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TimeslickWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TimeslickWeb.Gettext, "errors", msg, opts)
    end
  end
