defmodule DttRecharger.OrganizationsTest do
  use DttRecharger.DataCase

  alias DttRecharger.Organizations

  describe "organizations" do
    alias DttRecharger.Organizations.Organization

    import DttRecharger.OrganizationsFixtures
